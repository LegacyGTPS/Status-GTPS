/*
* Coded by Legacy#2178
* Create by Legacy#2178.& einnor#5410
*/
const Discord = require('discord.js')
const client = new Discord.Client()
var fs = require('fs');
const config = require("./botsconfig.json")
...
client.on('ready', () => {
  ...
  client.user.setActivity('GTPS Status', { type: 'LISTENING' });

  	const statusz = new Discord.MessageEmbed()
	.setColor('#ff0000')
	.setAuthor(`GTPS Status`)
	.addField('*Server Status:**', '**DOWN**')
	.addField('Users Online:', 'Please wait.')
	.setTimestamp()
...
isRunning('enet server test.exe', (status) => {
    if (status == true) {
	...
	.addField('**Users Online:**', line)
	.addField('**Users File Count: **', f1)
	.addField('**World File Count: **', f2)
	...
	.addField('**Users Online:**', '0')
        .addField('**User File Count: **', f1)
	.addField('**World File Counts: **', f2)
        .addField('**Guild File Count: **', f3)
	.setTimestamp()
	.setFooter('Last Updated');
